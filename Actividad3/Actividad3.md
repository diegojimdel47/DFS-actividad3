...
## Descripción
Este programa registra los datos de dos productos y valida que la información sea correcta, y tras aplicar un porcentaje de impuestos y de ganancia, calcula y compara sus precios finales para determinar cual producto es el más caro.
## Código
```java
